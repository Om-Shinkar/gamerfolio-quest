		...
		extend: {
			colors: {
				...
				gaming: {
					...
					'card-hover': 'rgba(93, 95, 239, 0.05)'
				},
				primary: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 5px rgba(93, 95, 239, 0.5)' },
					'50%': { boxShadow: '0 0 20px rgba(93, 95, 239, 0.8)' }
				},
				'scale-in': {
			...
			backgroundImage: {
				...
				'text-gradient': 'linear-gradient(90deg, #5D5FEF, #7879F1)'
			}
		}
	},
